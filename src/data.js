...
export const SPECIES = [
  ...
  { id: 'atlantic_thread_herring', commonName: 'Atlantic Thread Herring', altNames: ['Threadfin herring', 'greenback', 'greenie'], scientific: 'Opisthonema oglinum', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'atlantic_croaker', commonName: 'Atlantic Croaker', altNames: ['Croaker', 'hardhead'], scientific: 'Micropogonias undulatus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'ballyhoo', commonName: 'Ballyhoo', altNames: ['Balao', 'halfbeak'], scientific: 'Hemiramphus brasiliensis', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bay_anchovy', commonName: 'Bay Anchovy', altNames: ['Anchovy', 'glass minnow'], scientific: 'Anchoa mitchilli', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'blue_runner', commonName: 'Blue Runner', altNames: ['Hardtail', 'runner'], scientific: 'Caranx crysos', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bonito', commonName: 'Bonito', altNames: ['Atlantic bonito'], scientific: 'Sarda sarda', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'cigar_minnow', commonName: 'Cigar Minnow', altNames: ['Round scad', 'cigarfish'], scientific: 'Decapterus punctatus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gulf_menhaden', commonName: 'Gulf Menhaden', altNames: ['Pogy', 'pogie', 'bunker', 'shad', 'menhaden'], scientific: 'Brevoortia patronus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'glass_minnow', commonName: 'Glass Minnow', altNames: ['Silverside', 'anchovy'], scientific: 'Anchoa spp.', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'ladyfish', commonName: 'Ladyfish', altNames: ['Skipjack', 'ten-pounder'], scientific: 'Elops saurus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'pinfish', commonName: 'Pinfish', altNames: ['Pin', 'sailor\'s choice'], scientific: 'Lagodon rhomboides', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gulf_porgy', commonName: 'Gulf Porgy', altNames: ['Longspine porgy', 'porgy'], scientific: 'Stenotomus caprinus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'scaled_sardine', commonName: 'Scaled Sardine', altNames: ['Pilchard', 'whitebait', 'greenback'], scientific: 'Harengula jaguana', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spanish_sardine', commonName: 'Spanish Sardine', altNames: ['Sardine'], scientific: 'Sardinella aurita', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spot_croaker', commonName: 'Spot Croaker', altNames: ['Spot', 'Norfolk spot'], scientific: 'Leiostomus xanthurus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'striped_anchovy', commonName: 'Striped Anchovy', altNames: ['Anchovy'], scientific: 'Anchoa hepsetus', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'yellowfin_menhaden', commonName: 'Yellowfin Menhaden', altNames: ['Menhaden', 'pogy'], scientific: 'Brevoortia smithi', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'squid', commonName: 'Squid', altNames: ['Calamari'], scientific: 'Doryteuthis spp.', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'pigfish', commonName: 'Pigfish', altNames: ['Grunt', 'piggy perch'], scientific: 'Orthopristis chrysoptera', category: 'baitfish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'atlantic_angel_shark', commonName: 'Atlantic Angel Shark', altNames: [], scientific: 'Squatina dumeril', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'basking_shark', commonName: 'Basking Shark', altNames: [], scientific: 'Cetorhinus maximus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bigeye_sand_tiger_shark', commonName: 'Bigeye Sand Tiger Shark', altNames: [], scientific: 'Odontaspis noronhai', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bigeye_sixgill_shark', commonName: 'Bigeye Sixgill Shark', altNames: [], scientific: 'Hexanchus nakamurai', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bigeye_thresher_shark', commonName: 'Bigeye Thresher Shark', altNames: [], scientific: 'Alopias superciliosus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bignose_shark', commonName: 'Bignose Shark', altNames: [], scientific: 'Carcharhinus altimus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'caribbean_reef_shark', commonName: 'Caribbean Reef Shark', altNames: [], scientific: 'Carcharhinus perezii', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'caribbean_sharpnose_shark', commonName: 'Caribbean Sharpnose Shark', altNames: [], scientific: 'Rhizoprionodon porosus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'dusky_shark', commonName: 'Dusky Shark', altNames: [], scientific: 'Carcharhinus obscurus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'galapagos_shark', commonName: 'Galapagos Shark', altNames: [], scientific: 'Carcharhinus galapagensis', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'longfin_mako_shark', commonName: 'Longfin Mako Shark', altNames: [], scientific: 'Isurus paucus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'narrowtooth_shark', commonName: 'Narrowtooth Shark', altNames: [], scientific: 'Carcharhinus brachyurus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'night_shark', commonName: 'Night Shark', altNames: [], scientific: 'Carcharhinus signatus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sevengill_shark', commonName: 'Sevengill Shark', altNames: [], scientific: 'Heptranchias perlo', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'silky_shark', commonName: 'Silky Shark', altNames: [], scientific: 'Carcharhinus falciformis', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'smalltail_shark', commonName: 'Smalltail Shark', altNames: [], scientific: 'Carcharhinus porosus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sixgill_shark', commonName: 'Sixgill Shark', altNames: [], scientific: 'Hexanchus griseus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sand_tiger_shark', commonName: 'Sand Tiger Shark', altNames: [], scientific: 'Carcharias taurus', category: 'sharks_rays', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spiny_dogfish', commonName: 'Spiny Dogfish', altNames: ['Spurdog', 'dogfish'], scientific: 'Squalus acanthias', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gulf_sturgeon', commonName: 'Gulf Sturgeon', altNames: [], scientific: 'Acipenser oxyrinchus desotoi', category: 'sharks_rays', federalStatus: 'protected', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'largetooth_sawfish', commonName: 'Largetooth Sawfish', altNames: [], scientific: 'Pristis pristis', category: 'sharks_rays', federalStatus: 'protected', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spotted_eagle_ray', commonName: 'Spotted Eagle Ray', altNames: ['Eagle ray'], scientific: 'Aetobatus narinari', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'giant_manta_ray', commonName: 'Giant Manta Ray', altNames: ['Manta ray', 'devil ray'], scientific: 'Mobula birostris', category: 'sharks_rays', federalStatus: 'protected', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'blue_shark', commonName: 'Blue Shark', altNames: [], scientific: 'Prionace glauca', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bull_shark', commonName: 'Bull Shark', altNames: [], scientific: 'Carcharhinus leucas', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'finetooth_shark', commonName: 'Finetooth Shark', altNames: [], scientific: 'Carcharhinus isodon', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'great_hammerhead_shark', commonName: 'Great Hammerhead Shark', altNames: ['Hammerhead'], scientific: 'Sphyrna mokarran', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'lemon_shark', commonName: 'Lemon Shark', altNames: [], scientific: 'Negaprion brevirostris', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'nurse_shark', commonName: 'Nurse Shark', altNames: [], scientific: 'Ginglymostoma cirratum', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'porbeagle_shark', commonName: 'Porbeagle Shark', altNames: [], scientific: 'Lamna nasus', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'smooth_hammerhead_shark', commonName: 'Smooth Hammerhead Shark', altNames: ['Hammerhead'], scientific: 'Sphyrna zygaena', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spinner_shark', commonName: 'Spinner Shark', altNames: [], scientific: 'Carcharhinus brevipinna', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'thresher_shark', commonName: 'Thresher Shark', altNames: [], scientific: 'Alopias vulpinus', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'tiger_shark', commonName: 'Tiger Shark', altNames: [], scientific: 'Galeocerdo cuvier', category: 'sharks_rays', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'alligator_gar', commonName: 'Alligator Gar', altNames: ['Gar', 'gator gar'], scientific: 'Atractosteus spatula', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'bonefish', commonName: 'Bonefish', altNames: ['Bone', 'gray ghost'], scientific: 'Albula vulpes', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'striped_mullet', commonName: 'Striped Mullet', altNames: ['Mullet', 'black mullet', 'jumping mullet'], scientific: 'Mugil cephalus', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'common_snook', commonName: 'Common Snook', altNames: ['Snook', 'linesider', 'robalo'], scientific: 'Centropomus undecimalis', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'swordspine_snook', commonName: 'Swordspine Snook', altNames: ['Snook', 'robalo'], scientific: 'Centropomus ensiferus', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'tarpon', commonName: 'Tarpon', altNames: ['Silver king', 'sabalo'], scientific: 'Megalops atlanticus', category: 'coastal', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'african_pompano', commonName: 'African Pompano', altNames: ['Pompano', 'threadfin trevally'], scientific: 'Alectis ciliaris', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'florida_pompano', commonName: 'Florida Pompano', altNames: ['Pompano'], scientific: 'Trachinotus carolinus', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gulf_flounder', commonName: 'Gulf Flounder', altNames: ['Flounder', 'flatfish', 'doormat'], scientific: 'Paralichthys albigutta', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'southern_flounder', commonName: 'Southern Flounder', altNames: ['Flounder', 'doormat', 'mud flounder'], scientific: 'Paralichthys lethostigma', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sheepshead', commonName: 'Sheepshead', altNames: ['Convict fish', 'sheephead', 'bay snapper'], scientific: 'Archosargus probatocephalus', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'permit', commonName: 'Permit', altNames: ['Round pompano'], scientific: 'Trachinotus falcatus', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'striped_bass', commonName: 'Striped Bass', altNames: ['Striper', 'rockfish', 'linesider'], scientific: 'Morone saxatilis', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gafftopsail_catfish', commonName: 'Gafftopsail Catfish', altNames: ['Gafftop', 'sailcat'], scientific: 'Bagre marinus', category: 'inshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'red_porgy', commonName: 'Red Porgy', altNames: ['Pink porgy', 'silver snapper'], scientific: 'Pagrus pagrus', category: 'offshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'jolthead_porgy', commonName: 'Jolthead Porgy', altNames: ['Porgy', 'jolt-head porgy'], scientific: 'Calamus bajonado', category: 'offshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'tripletail', commonName: 'Tripletail', altNames: ['Blackfish', 'buoy fish', 'flasher', 'leaf fish'], scientific: 'Lobotes surinamensis', category: 'offshore', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'yellowedge_grouper', commonName: 'Yellowedge Grouper', altNames: ['Yellowedge grouper'], scientific: 'Hyporthodus flavolimbatus', category: 'groupers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'misty_grouper', commonName: 'Misty Grouper', altNames: ['Misty grouper'], scientific: 'Hyporthodus mystacinus', category: 'groupers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'coney', commonName: 'Coney', altNames: ['Coney grouper'], scientific: 'Cephalopholis fulva', category: 'groupers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'graysby', commonName: 'Graysby', altNames: ['Graysby grouper'], scientific: 'Cephalopholis cruentata', category: 'groupers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'speckled_hind', commonName: 'Speckled Hind', altNames: ['Kitty Mitchell', 'Kitty Mitchell', 'calico grouper'], scientific: 'Epinephelus drummondhayi', category: 'groupers', federalStatus: 'restricted', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'yellowfin_grouper', commonName: 'Yellowfin Grouper', altNames: ['Yellowfin grouper'], scientific: 'Mycteroperca venenosa', category: 'groupers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'blackline', commonName: 'Blackline', altNames: ['Blackline tilefish'], scientific: 'Caulolatilus cyanops', category: 'tilefish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'gulf_bareye', commonName: 'Gulf Bareye', altNames: ['Anchor', 'Anchor tilefish'], scientific: 'Caulolatilus intermedius', category: 'tilefish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'goldface', commonName: 'Goldface', altNames: ['Goldface tilefish'], scientific: 'Caulolatilus chrysops', category: 'tilefish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sand', commonName: 'Sand', altNames: ['Sand tilefish'], scientific: 'Malacanthus plumieri', category: 'tilefish', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'jack_crevalle', commonName: 'Jack Crevalle', altNames: ['Crevalle jack', 'jack', 'toro'], scientific: 'Caranx hippos', category: 'jacks', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'black_snapper', commonName: 'Black Snapper', altNames: ['Black snapper'], scientific: 'Apsilus dentatus', category: 'snappers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'schoolmaster_snapper', commonName: 'Schoolmaster Snapper', altNames: ['Schoolmaster snapper', 'barred snapper'], scientific: 'Lutjanus apodus', category: 'snappers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'dog_snapper', commonName: 'Dog Snapper', altNames: ['Dog snapper'], scientific: 'Lutjanus jocu', category: 'snappers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'mahogany_snapper', commonName: 'Mahogany Snapper', altNames: ['Mahogany snapper'], scientific: 'Lutjanus mahogoni', category: 'snappers', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'red_drum', commonName: 'Red Drum', altNames: ['Redfish', 'Redfish', 'red', 'channel bass', 'spottail bass'], scientific: 'Sciaenops ocellatus', category: 'drums_trouts', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'spotted_seatrout', commonName: 'Spotted Seatrout', altNames: ['Speckled trout', 'specks', 'trout', 'spotted weakfish'], scientific: 'Cynoscion nebulosus', category: 'drums_trouts', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'weakfish', commonName: 'Weakfish', altNames: ['Gray trout', 'sea trout', 'tiderunner'], scientific: 'Cynoscion regalis', category: 'drums_trouts', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'silver_seatrout', commonName: 'Silver Seatrout', altNames: ['Silver trout', 'sand trout'], scientific: 'Cynoscion nothus', category: 'drums_trouts', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'sand_seatrout', commonName: 'Sand Seatrout', altNames: ['White trout', 'sand trout'], scientific: 'Cynoscion arenarius', category: 'drums_trouts', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'great_barracuda', commonName: 'Great Barracuda', altNames: ['Cuda', 'barracuda'], scientific: 'Sphyraena barracuda', category: 'mackerels_barracuda', keyIds: [], lookalikes: [], habitat: '' },
  { id: 'longbill_spearfish', commonName: 'Longbill Spearfish', altNames: ['Spearfish'], scientific: 'Tetrapturus pfluegeri', category: 'billfish', federalStatus: 'prohibited', keyIds: [], lookalikes: [], habitat: '' },
];
